...
export const LOBE_CHAT_CLOUD = 'Cyberistor Cloud';

export const BRANDING_NAME = 'Cyberistor';
export const BRANDING_LOGO_URL = '/icons/cyberistor-logo.png';

export const ORG_NAME = 'Cyberistor';
